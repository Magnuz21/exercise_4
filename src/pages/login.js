    ...
    const handleSubmit = (e) => {
        ...
        if (!username) {
            ...
            if (Object.keys(errors).length === 0) {
                if (username === "aldrinabilar21" && password === "admin123") {
                    router.push("./board");
                  } else {
                    setShowDialog(true);
                  }
                 ...
                 <form onSubmit={handleSubmit}>
                    ...
                    <div className="relative flex flex-col mb-2">
                        <input type="text" 
                          ...
                          border-lime-500 h-10 bg-transparent text-gray-100 font-mono outline-none px-2 peer 
                    ...
                    <button type="submit"
                        className="py-3 mt-10 font-mono text-gray-100 bg-lime-500 w-full rounded hover:bg-lime-600
